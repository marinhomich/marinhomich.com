...
export default function Search() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden xl:inline-flex">Search here...</span>
      <kbd className="pointer-events-none absolute right-1.5 top-2 hidden h-6 select-none items-center gap-1 rounded bg-stone-700 px-1.5 font-mono text-[10px] font-medium opacity-100 xl:flex">
